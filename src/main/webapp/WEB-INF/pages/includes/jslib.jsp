<script type="text/javascript" src="${pageContext.request.contextPath}/lib/bootstrap/js/jquery.js"></script>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/admin_panel.js"></script>